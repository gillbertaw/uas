      ...
      <div id="body-korea">
        <main className="main-korea">
          <section className="container-fluid" id="korea-top">
            <img
              src="images/korea/korea background.png"
            ...
            <div className="container">
              <div className="row align-items-center">
                <div className="col-lg-7" id="road-trip">
                  <p className="display-5 fw-bold mb-3">7-Day Korea Road Trip — Spring & Autumn Friendly</p>
                  <div id="road-trip-tips">
                    <h3>Road trip tips</h3>
                    <ul id="road-trip-list">
                        <li>Rent a car with GPS or use Naver/Gaode alternatives for navigation.</li>
                        <li>Tolls: expect highway tolls; keep cash or card ready.</li>
                ...
                <div className="col-lg-5">
                  <div className="card p-3"  id="card-trip">
                    ...
                    <div className="card-subtitle ps-2">~1,155 km total (approx.) • Moderate pace</div>
                    <hr/>
                    <div className="card-text">
                      <div className="d-flex gap-3">
                          ...
                          <div>
                              ...
                              <div className="text-muted">Spring (Apr–May) &amp; Autumn (Sep–Oct)</div>
                          </div>
                      </div>
                      <div className="d-flex gap-3">
                        <div className="feature-icon">🚗</div>
                        <div>
                            ...
                            <div className="text-muted">Mostly 1–4 hour daily drives, relaxed stops</div>
                        </div>
                      </div>
                    </div>
                  </div>
