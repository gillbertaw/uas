...
const story_paragraph = [
  "Our journey began with a simple idea — to make traveling easier and more meaningful for everyone. We realized that many people often struggle to decide where to go or how to plan their vacations, sometimes wasting valuable time searching for the right destinations. From that challenge, our project was born.",
  "We built this website as a smart and reliable tour guide platform designed to help travelers easily locate the best places to visit in every country. With our detailed road maps and curated destination guides, we aim to turn every trip into a smooth and memorable experience. Over time, our platform has grown steadily, reaching more users and expanding to cover more destinations worldwide — and we’re just getting started.",
];

const mission_paragraph = [
  "Our mission is to help people discover the most exciting and meaningful destinations wherever they travel. We want to make it effortless for travelers of all backgrounds and ages to plan their journeys with confidence.",
  "We’re committed to providing information that’s not only accurate and high-quality but also practical and inspiring. By combining precision, clarity, and a passion for exploration, we strive to be the go-to platform for anyone seeking a better way to experience the world.",
];
...
const founder_images = [
  {
    src: william,
    alt: "William Wiryawan",
    name: "William Wiryawan",
    status: "Founder",
    desc: "Responsible for login page and list country",
  },
  {
    src: wilhan,
    alt: "Wilhan",
    name: "Wilhan",
    status: "Founder",
    desc: "Responsible for japan page, tokyo, kyoto, osaka",
  },
  {
    src: dei,
    alt: "Deidrich Zhu",
    name: "Deidrich Zhu",
    status: "Founder",
    desc: "Responsible for home page, user-demo, swizz and australia page",
  },
  {
    src: dicky,
    alt: "Dicky Saskia",
    name: "Dicky Saskia",
    status: "Founder",
    desc: "Responsible for Malaysia, Singapura, Thailand, Vitenam page",
  },
  {
    src: gaw,
    alt: "Gillbert Allison Wijaya",
    name: "Gillbert Allison Wijaya",
    status: "Founder",
    desc: "Responsible for faq, about, china, korea page",
  },
];
...
class About extends React.Component {
  ...
  render() {
    ...
    if (this.state.selectedFounder === false) {
      founderDetail = (
        <p className="text-muted mt-4">Click a founder to see details</p>
      );
    } else {
      founderDetail = (
        <div className="mt-4 p-4 rounded bg-light">
          <h4 className="fw-bold">{this.state.selectedFounder.name}</h4>
          <p className="text-muted">{this.state.selectedFounder.status}</p>
          <p>{this.state.selectedFounder.desc}</p>
        </div>
      );
    }
    return (
        ...
        <main id="main-about">
              ...
              <div className="row align-items-center text-center text-md-start">
                ...
                <div className="col-md-6" id="companystory-right">
                  <h2
                    ...
                    id="companystory-title"
                  >
                    Our Story
                  </h2>
                  <button
                    className="button-story-mission"
                    onClick={() =>
              ...
              <div className="row align-items-center text-center text-md-start">
                <div className="col-md-6" id="mission-left">
                  ...
                  <button
                    ...
                    onClick={() =>
                      this.setState({
                        showOurMission: !this.state.showOurMission,
                      })
                    }
                  >
                  ...
                  <div
                    className={`mission-content ${
                      this.state.showOurMission ? "show" : ""
                    }`}
                  >
                ...
                <div className="col-md-6" id="mission-right">
                  <div className="mb-3">
                    <img
                      src={mission_images[0].src}
                      alt={mission_images[0].alt}
                      className="img-fluid"
                      id="mission-img"
                    />
                  </div>
          ...
          <section className="container-fluid" id="main-founders">
            <section className="container text-center" id="founders-content">
              <h2 className="fw-bold text-primary" id="founders-title">
                Meet Our Founders
              </h2>
              ...
              >
                <div className="carousel-indicators" id="carouselindicators">
                  <button
                    ...
                    className="active"
                    aria-current="true"
                    aria-label="Founder 1"
                  ></button>
                  <button
                    type="button"
                    data-bs-target="#carouselExampleCaptions"
                    data-bs-slide-to="1"
                    aria-label="Founder 2"
                  ></button>
                  <button
                    type="button"
                    data-bs-target="#carouselExampleCaptions"
                    data-bs-slide-to="2"
                    aria-label="Founder 3"
                  ></button>
                  <button
                    type="button"
                    data-bs-target="#carouselExampleCaptions"
                    data-bs-slide-to="3"
                    aria-label="Founder 4"
                  ></button>
                  <button
                    type="button"
                    data-bs-target="#carouselExampleCaptions"
                    data-bs-slide-to="4"
                    aria-label="Founder 5"
                  ></button>
                </div>
