                ...
                <div className="accordion-item" id="accordionitems1">
                  <h2 className="accordion-header" id="accordionheader1">
                    <button
                      ...
                      data-bs-target="#acorr1"
                      aria-expanded="true"
                      aria-controls="acorr1"
                      id="accordionbutton1"
                    >
                  ...
                  >
                    <div className="accordion-body" id="accordionbody1">
                      <p>
                        Click the <strong>User Icon</strong> choose{" "}
                        <strong>Login</strong> if you already have an account.
                        If not, click <strong>Sign Up</strong> to create one.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="accordion-item" id="accordionitems2">
                  <h2 className="accordion-header" id="accordionheader2">
                    <button
                      ...
                      type="button"
                      data-bs-toggle="collapse"
                      data-bs-target="#accor2"
                      aria-expanded="false"
                      aria-controls="accor2"
                      id="accordionbutton2"
                    >
                  ...
                  >
                    <div className="accordion-body" id="accordionbody2">
                      <p>
                        Follow the steps to reset your password securely and
                ...
                <div className="accordion-item" id="accordionitems3">
                  <h2 className="accordion-header" id="accordionheader3">
                    <button
                      ...
                      type="button"
                      data-bs-toggle="collapse"
                      data-bs-target="#accor3"
                      aria-expanded="false"
                      aria-controls="accor3"
                      id="accordionbutton3"
                    >
                      What kind of country information do you provide?
                    </button>
                  </h2>
                  <div
                    id="accor3"
                  ...
                  >
                    <div className="accordion-body" id="accordionbody3">
                      <p>
                        Each country page includes a brief overview, top
                        destinations, must-visit landmarks, and suggested travel
                        routes.
                      </p>
                    </div>
                  </div>
                ...
                <div className="accordion-item" id="accordionitems4">
                  <h2 className="accordion-header" id="accordionheader4">
                    <button
                      ...
                      type="button"
                      data-bs-toggle="collapse"
                      data-bs-target="#accor4"
                      aria-expanded="false"
                      aria-controls="accor4"
                      id="accordionbutton4"
                    >
