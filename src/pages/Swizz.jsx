        ...
        <div className="background-aus">
          ...
          <div className="container d-flex justify-content-between flex-wrap">
            <div className="au-welcome">
              <h2 className="au-welcome-text">Switzerland travel recommendations</h2>
            ...
            <div className="row row-cols-1 row-cols-md-4 g-4">
              <div className="col col-sydney d-flex">
                <div className="card flex-fill">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">Scenic city known for its preserved medieval architecture and lake.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="col col-GreatBarrier d-flex">
                <div className="card flex-fill">
                  <img src={pilatus} className="card-img-top" alt="Mt. Pilatus" />
                  <div className="card-body">
                    <h5 className="card-title">Mt. Pilatus</h5>
                    <p className="card-text">Known for scenic views and steep cogwheel railway.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="col col-Uluru d-flex">
                <div className="card flex-fill">
                  <img src={interlaken} className="card-img-top card-uluru" alt="Interlaken" />
                  <div className="card-body">
                    <h5 className="card-title">Interlaken</h5>
                    <p className="card-text">Popular town in the Bernese Oberland region.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="col col-Melbourne d-flex">
                <div className="card flex-fill">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">Prominent mountain in the Swiss Alps.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="about-au">
              ...
              <p>Switzerland is a mountainous, landlocked country in Central Europe, famous for its Alps and multicultural society.</p>
            </div>
          </div>
        </div>
      </div>
