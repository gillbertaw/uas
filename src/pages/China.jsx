      ...
      <div id="body-china">
        <main className="main-china">
          ...
          <section className="container-fluid" id="china-top">
            <img
              src="images/china/china background.jpg"
              alt="China Background"
              id="china-background"
              className="img-fluid"
            />
            <div className="container" id="china-title">
              <Link to="/list-tiket"><button
                className="btn"
                id="button-back">
                🔙 Back
              </button></Link>
              ...
              <div className="row align-items-center">
                <div className="col-lg-7" id="road-trip">
                  ...
                  <div id="road-trip-tips">
                    ...
                    <ul id="road-trip-list">
                      <li>You need a Chinese driving permit, foreign licenses aren't valid, so hire a car with local driver or join a guided self-drive tour</li>
                      <li>Use Baidu Maps or Gaode (Amap) with English labels.</li>
                ...
                <div className="col-lg-5">
                  <div className="card p-3" id="card-trip">
                    ...
                    <div className="card-subtitle ps-2">~1,860 km total (approx.) • Moderate pace</div>
                    <hr />
